...
const Register = () => {
  ...
  if (registered) {
    ...
    <section className="relative py-20 2xl:py-40 bg-gray-200 overflow-hidden">
          ...
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-cyan-800">
                  Create an account and start pen down your ideas
                </h2>
              </div>
            </div>
